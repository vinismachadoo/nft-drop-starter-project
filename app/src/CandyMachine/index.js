...
const CandyMachine = ({ walletAddress }) => {
  ...
  const mintToken = async () => {
    try {
      setIsMinting(true);
      // create an account to the to the NFT (Solana is stateless while Ethereum contracts holds states)
      ...
      // all the params the candy machine needs to mint the NFT
      const accounts = {
        config,
      ...
      const signers = [mint];
      // intructions aka funcionts held by metaplex; we just call them
      const instructions = [
      ...
      // the actual call to mint and where the magic happens
